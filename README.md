...
- 企业收入：记录客户回款、主营业务收入、项目收入、订阅收入和其他收入。
- 成本支出：记录人力成本、办公租赁、云服务、市场投放、差旅交通、采购和行政支出。
- 税费管理：规划增值税、企业所得税、个税、附加税等税费记录、估算和提醒。
...
企业版完整产品蓝图见 [docs/ENTERPRISE_PRODUCT_POSITIONING.md](docs/ENTERPRISE_PRODUCT_POSITIONING.md)，权限矩阵见 [docs/ENTERPRISE_PERMISSION_MATRIX.md](docs/ENTERPRISE_PERMISSION_MATRIX.md)，多公司与地区政策规划见 [docs/ENTERPRISE_MULTI_COMPANY_POLICY.md](docs/ENTERPRISE_MULTI_COMPANY_POLICY.md)。
