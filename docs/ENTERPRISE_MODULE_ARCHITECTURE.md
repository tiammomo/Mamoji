...
- 将企业、人员和税务等剩余兼容模型迁出 `EnterpriseStore`；分类、预算、周期事项、流水、资金账户、账本及成员的强类型持久化已经完成。
