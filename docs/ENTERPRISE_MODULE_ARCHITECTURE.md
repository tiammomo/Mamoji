...
- 将分类等剩余兼容模型迁出旧 Store；预算、周期事项、流水、资金账户、账本及成员的强类型持久化已经完成。
