...
| `departments`、`employees`、`employment_events` | People Core | 部门由 `DepartmentRepository` 直接读写 PostgreSQL；Workforce Cost 仅通过有范围约束的 SQL 投影读取 |
